      ...
      <div id="subMenu" class="panel panel-default">
         <ul class="subMenuHighlight panel-heading">
            <li class="subMenuHighlight panel-title" id="subMenuHighlight">
               <a id="li_291" class="subMenuHighlight" href="index.php"><span>Signup</span></a>
            </li>
         </ul>
         ...
         <ul class="panel-heading">
            <li class="panel-title">
               <a class="subMenu1" href="index.html"><span>SignIn</span></a>
            </li>
         </ul>
      </div>
...
//    $email=$_POST['email'];
  //  $password = $_GET['passsword'];
    ...
    //$query = mysqli_query($con,"SELECT * FROM register_login WHERE email='$email'")
